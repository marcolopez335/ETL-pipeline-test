...
from conversion.shared_polars import test_connection, load_config
from conversion.console import print_header, print_success, print_error, console
from conversion import stories_table_polars as stories
from conversion import epics_table_polars as epics
...
def main():
    parser = argparse.ArgumentParser(description="ODBC data pipeline (Polars)")
    ...
    console.print()
    console.rule("[bold cyan]ODBC Data Pipeline (Polars)[/]", style="cyan")
    console.print()
